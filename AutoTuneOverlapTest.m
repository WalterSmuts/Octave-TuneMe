clear;
t = 0:44100*5;
y = sin((1000*2*pi*t + t.^2/100)/44100);

% 20ms Segments
seg = segmentWithOverlap(y,44100/50,5);
...
for (i = 1:length(seg(:,1)))
	...
	out = [out; shiftPitch(seg(i,:),round(wantedContour(i)),round(freqContour(i)))(1:882)]; % Hack because shiftPitch is not well behaved
endfor
out = stitchWithOverlap(out,5);
